...
class UpdateActionCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'crud-action:update {name} {--f|force}';
    ...
    {
        list($name, $namespace, $singular, $plural, $class, $model) = $this->stubVariables('Update');
...
//        dd($stub);
        ...
        $this->info("UpdateAction generated at {$path}");
    ...
    {
        $stub_path = 'stubs/action-update.stub';
