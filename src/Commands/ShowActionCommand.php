...
class ShowActionCommand extends Command
{
    use CommandHelper;
     ...
     * @var string
     */
    protected $signature = 'crud-action:show {name} {--f|force}';
    ...
    {
        list($name, $namespace, $singular, $plural, $class, $model) = $this->stubVariables('Show');
...
//        dd($stub);
        ...
        $this->info("ShowAction generated at {$path}");
    ...
    {
        $stub_path = 'stubs/action-show.stub';
